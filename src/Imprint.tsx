        ...
        <div className="bg-white px-6 py-32 lg:px-8">
            <div className="mx-auto max-w-3xl text-base leading-7 text-gray-700">
                ...
                <div className="mt-10 max-w-2xl">
                    <h2 className="mt-16 text-2xl font-bold tracking-tight text-gray-900">Anschrift</h2>
                    <p className="mt-6">
                        Angaben gem. § 5 TMG: <br/>
                        prevery GmbH (in Gründung)<br/>
                        Plankgasse 20<br/>
                        50668 Köln
                    ...
                    <h2 className="mt-16 text-2xl font-bold tracking-tight text-gray-900">Kontaktaufnahme</h2>
                    <p className="mt-6">
                        hey@prevery.de
                    </p>
                    <h2 className="mt-16 text-2xl font-bold tracking-tight text-gray-900">Haftungsausschluss</h2>
                    <h2 className="mt-8 text-xl font-bold tracking-tight text-gray-900">Haftung für Inhalte</h2>
                    <p className="mt-6">
                    ...
                    <h2 className="mt-16 text-xl font-bold tracking-tight text-gray-900">Haftungsbeschränkung für
                        externe Links</h2>
                    <p className="mt-6">
                        ...
                        „www.qours.es“ gesetzten Links und Verweise von Fragestellern, Blogeinträgern, Gästen des
