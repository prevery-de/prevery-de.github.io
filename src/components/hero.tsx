            ...
            <header className="absolute inset-x-0 top-0 z-50">
                <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
                    <div className="flex lg:flex-1">
                        <div className="text-prevery-800 font-ubuntu text-xl -m-1.5 p-1.5">
                            <img src='/green-orange.svg' className="h-10 w-auto" alt="Logo"/>
                        </div>
                    </div>
            ...
            <div className="relative isolate pt-14">
                ...
                <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:py-40">
                    <div className="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
                        <h1 className="font-ubuntu font-normal max-w-lg text-4xl tracking-tight text-gray-900 sm:text-6xl">
