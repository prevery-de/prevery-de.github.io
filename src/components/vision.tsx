export default function Vision() {
    return (
        <div className="bg-[#FEFEFE] py-24 sm:py-32">
                        ...
                        <div className="relative overflow-hidden rounded-3xl bg-gray-900 px-6 pb-9 pt-64 shadow-2xl sm:px-12 lg:max-w-lg lg:px-8 lg:pb-8 xl:px-10 xl:pb-10">
                            ...
                            <figure className="relative isolate">
                                ...
                                <blockquote className="mt-6 text-xl font-semibold leading-8 text-white">
                                    <p>
                                        Durch eine einfache Handhabung, nutzerorientierte und wertschätzende Kommunikation sowie ein ansprechendes Design werden wir dir den Zugang zu einem gesunden Lebensstil erleichtern.
                                    </p>
                                </blockquote>
                                <figcaption className="mt-6 text-sm leading-6 text-gray-300">
                                    <strong className="font-semibold text-white">Dr. med. Timo Trampert,</strong> Founder prevery GmbH (in Gründung)
                                </figcaption>
                            </figure>
                        </div>
                    </div>
